...
try{    
    ...
    /**สร้างเอกสาร docx */
    $templateProcessor = new TemplateProcessor('template.docx');//เลือกไฟล์ template ที่เราสร้างไว้
    ...
    $templateProcessor->saveAs('ven_somtop.docx');//สั่งให้บันทึกข้อมูลลงไฟล์ใหม่
    ...
    echo json_encode(array( 
        ...
        // 'holiday'=> $HLD,
        // 'datas' =>  $datas,
        'url_link' => 'api/word/ven_somtop.docx'
    ));
